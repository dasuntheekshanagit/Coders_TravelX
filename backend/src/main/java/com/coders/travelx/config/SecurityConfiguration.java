package com.coders.travelx.config;
...
import static com.coders.travelx.util.Permission.*;
import static com.coders.travelx.util.Role.ADMIN;
import static com.coders.travelx.util.Role.USER;
